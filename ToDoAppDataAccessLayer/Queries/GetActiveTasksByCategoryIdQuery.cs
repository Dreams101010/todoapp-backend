...
{
    public class GetActiveTasksByCategoryIdQuery
        : IQuery<GetActiveTasksByCategoryIdQueryParameter, IEnumerable<ToDoTaskOutputModel>>
    {
        private NpgsqlConnection Connection { get; set; }

        public GetActiveTasksByCategoryIdQuery(NpgsqlConnection connection)
        {
        ...
        public IEnumerable<ToDoTaskOutputModel> Execute(GetActiveTasksByCategoryIdQueryParameter param)
        {
            string selectQuery = "SELECT todotask.id, todotask.title, todotask.description, todotask.createdat, " +
                ...
                "ORDER BY todotask.iscomplete ASC, todotask.createdat DESC";
